...
vector< vector<float> > readfilelibras() {
    ifstream myfile("C:\\Users\\marin\\ClionProjects\\P5\\movement_libras.arff");
    vector<float> v;
...
int main() {
    ...
    while(eval < 15000){
        ...
        // Puesto que la probabilidad de que se aplique BL es de 0.1 para cada cromosoma
        // y nuestra población tiene 10 cromosomas, se aplicará BL sobre un cromosoma
        // que escogemos aleatoriamente
 ...
 * Tasa = 74,4444
 * Reducción = 48,8889
 * Tiempo = 39,048 x 15 - 40
 *
 * Semilla: 46 - SIN intercambio
 *
 * Tasa = 67,2222
 * Reducción = 45,5556
 * Tiempo = 45,452 x 15 - 40
 *
 ...
 * Tasa = 70,5556
 * Reducción = 47,7778
 * Tiempo = 43,418 x 15 - 40
 *
 * Semilla: 6 - SIN intercambio
 *
 * Tasa = 71,6667
 * Reducción = 44,4444
 * Tiempo = 43,666 x 15 - 40
 *
 * Semilla: 33 - CON intercambio
 *
 * Tasa = 72,7778 / 72,7778
 * Reducción = 51,1111 / 48,8889
 * Tiempo = 39,769 x 15 = 569,535 / 501,268
 *
 * Semilla: 33 - SIN intercambio
 *
 * Tasa = 73,3333 / 72,7778
 * Reducción = 58,8889 / 56,6667
 * Tiempo = 31,079 x 15 = 466,185 / 442,987
 *
 *
 */
